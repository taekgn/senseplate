...
public class DatabaseSQLite extends SQLiteOpenHelper {
    ...
    public static final String DIA_COL_8 = "mealType";
    public static final String DIA_COL_9 = "date";
    public static final String DIA_COL_10 = "time";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("create table " + TABLE_DIARY + " (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, foodID TEXT, foodItem TEXT, calories TEXT, carbs TEXT, protein TEXT, fat TEXT, mealType TEXT, date TEXT, time TEXT)");
    ...
    public boolean insertFoodDiary(String foodID, String foodItem, String calories, Float carbs, Float protein, Float fat, String mealType, String date, String time) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
        ...
        contentValues.put(DIA_COL_8, mealType);
        contentValues.put(DIA_COL_9, date);
        contentValues.put(DIA_COL_10, time);
    ...
    public Cursor getFoodDiary(String whereQuery) {
        SQLiteDatabase db = this.getWritableDatabase();
        Cursor data = db.rawQuery("SELECT id, foodID, foodItem, calories, carbs, protein, fat, mealType, date, time FROM food_diary " + whereQuery + " ORDER BY id ASC;",null);
        return data;
    }

    public Cursor getFoodDiaryGraph() {
        SQLiteDatabase db = this.getWritableDatabase();
        Cursor data = db.rawQuery("SELECT id, foodItem, calories, carbs, protein, fat, date, time FROM food_diary ORDER BY date ASC;",null);
        return data;
    }

    public Cursor getUniqueDatesDiary() {
        SQLiteDatabase db = this.getWritableDatabase();
        Cursor data = db.rawQuery( "SELECT DISTINCT date FROM food_diary ORDER BY date ASC;",null);
        return data;
    }
