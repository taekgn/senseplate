...
public class SearchAdapter extends RecyclerView.Adapter<SearchAdapter.SearchViewHolder> {
    ...
    class SearchViewHolder extends RecyclerView.ViewHolder {
        TextView foodItemTextView, caloriesTextView;
        ...
        SearchViewHolder(View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    getFood(foodItem, calories, protein, fat, carbs);
                }
            });
        }
    }
    ...
    public void getFood(String foodItem, String calories, String fats, String protein, String carbs) {
        context.startActivity(new Intent(context, FoodActivity.class).putExtra("foodID", foodItem).putExtra("foodItem", foodItem).putExtra("calories", calories).putExtra("fat", fats).putExtra("protein", protein).putExtra("carbs", carbs).addFlags(Intent.FLAG_ACTIVITY_NEW_TASK));
    }
